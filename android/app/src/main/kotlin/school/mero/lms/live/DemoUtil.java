...
import school.mero.lms.live.cornet.CronetDataSourceFactory;
import school.mero.lms.live.cornet.CronetEngineWrapper;
...
//  }
  ...
  public static void updateHeaders(Context context, String id, String token){

    Map<String, String> map = new HashMap<String, String>();
    if(id!=null){
      map.put("Authorization", ""+id);  //strickly add

    }
    Log.d("HeaderJWT", "JWT Id "+ id);

    if(httpDataSourceFactory == null ){
      httpDataSourceFactory = getHttpDataSourceFactory(context);
    }

    httpDataSourceFactory.getDefaultRequestProperties().set(map);
    ...
    if (downloadManager == null) {
      ...
      downloadManager.addListener(new DownloadManager.Listener() {
        ...
        public void onDownloadChanged(DownloadManager downloadManager, Download download, @Nullable Exception finalException) {
          Log.d("onDownloadChanged", ""+ download.getPercentDownloaded());
        }
      });
      downloadTracker =
