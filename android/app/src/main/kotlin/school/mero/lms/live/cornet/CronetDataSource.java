 ...
 */
package school.mero.lms.live.cornet;
    ...
    if (responseCode < 200 || responseCode > 299) {
      ...
      InvalidResponseCodeException exception =
          new InvalidResponseCodeException(
              responseCode,
              responseInfo.getHttpStatusText(), new OpenException(new InterruptedIOException(), dataSpec, Status.INVALID),
          ...
          exception =
              new InvalidResponseCodeException(
                  ...
                  info.getHttpStatusText(),
                      new OpenException(new InterruptedIOException(), dataSpec, Status.INVALID),
                  info.getAllHeaders(),
                  dataSpec,
