...
import static school.mero.lms.live.DemoUtil.DOWNLOAD_NOTIFICATION_CHANNEL_ID;
...
import school.mero.lms.MainActivityKt;
...
//  public void setIds(int id, String token){
//    this.id = id;
//    this.token = token;
//  }
  ...
  private static final class TerminalStateNotificationHelper implements DownloadManager.Listener {
    ...
    public void onDownloadChanged(
      ...
      //insert into db
      Log.d("NotificationState", download.getPercentDownloaded()+":cganged "+ download.state);
      ...
      if (download.state == Download.STATE_COMPLETED) {
        ...
        Intent intent =  new Intent(context, DownloadActivity.class); //DownloadActivity
        ...
        Log.d("NotificationState", download.getPercentDownloaded()+":"+ download.state);
