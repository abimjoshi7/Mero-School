...
class _BetterPlayerCupertinoControlsState
  ...
  GestureDetector _buildNextVideo(Color iconColor, double barHeight) {
    return GestureDetector(
      onTap:  () {
  ...
  GestureDetector _buildPreviousVideo(Color iconColor, double barHeight) {
    return GestureDetector(
      onTap:  () {
  ...
  GestureDetector _buildSpeedWidget(
      Color backgroundColor,
      Color iconColor,
      double barHeight,
      double buttonPadding,
  ...
  GestureDetector _buildDownloadWidget(
      Color backgroundColor,
      Color iconColor,
      double barHeight,
      double buttonPadding,
    ...
    return GestureDetector(
      onTap: (){
        // showQualityChooserDownloadDialog();
  ...
  GestureDetector _buildQualityWidget(
      Color backgroundColor,
      Color iconColor,
      double barHeight,
      double buttonPadding,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          _buildPreviousVideo(iconColor, barHeight),
          _buildNextVideo(iconColor, barHeight),


          _buildSpeedWidget(backgroundColor, iconColor, barHeight, 0),
          // _buildDownloadWidget(backgroundColor, iconColor, barHeight, 0),
          _buildQualityWidget(backgroundColor, iconColor, barHeight, 0),
