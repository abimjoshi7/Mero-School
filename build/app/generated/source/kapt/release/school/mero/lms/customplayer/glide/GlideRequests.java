...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof school.mero.lms.customplayer.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new school.mero.lms.customplayer.glide.GlideOptions().apply(toSet));
    }
  }
}
