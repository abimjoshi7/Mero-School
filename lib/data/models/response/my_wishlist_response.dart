...
class MyWishlistResponse {
  ...
  MyWishlistResponse({bool? status, String? message, List<Data>? data}) {
    _status = status;
    _message = message;
    _data = data;
  }

  MyWishlistResponse.fromJson(dynamic json) {
    _status = json["status"];
...
/// level : "beginner"
/// user_id : "1"
/// thumbnail : "http://demo.mero.school/uploads/thumbnails/course_thumbnails/course_thumbnail_default_2.jpg?time="
...
/// total_enrollment : 8
/// shareable_link : "http://demo.mero.school/home/course/php-tutorial/2"
